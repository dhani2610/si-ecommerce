                    ...
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <form role="form text-left" method="POST" action="{{ route('tambah-payment-information') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            <label for="">No Rekening/Wallet</label>
                                            <input type="integer" class="form-control" placeholder="No Rekening/Wallet" name="no_payment" id="no_payment" required>
                                            @error('no_payment')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                            @enderror
                                        </div>
                        ...
                        <table id="myDataTable" class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0">{{ $item->no_payment }}</p>
                                    </td>
                                    <td class="text-center">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{ route('delete-payment-information',$item->id) }}" type="button" >
...
<div class="modal fade" id="modaledit{{ $item2->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <form role="form text-left" method="POST" action="{{ route('update-payment-information',$item2->id) }}" enctype="multipart/form-data">
            @csrf
            <div class="modal-body">
                    @csrf
                    <div class="mb-3">
                        <label for="">Name</label>
                        <input type="text" class="form-control" placeholder="Name" value="{{ $item2->nama }}" name="nama" id="nama" required>
                        @error('nama')
                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="mb-3">
                        <label for="">No Rekening/Wallet</label>
                        <input type="integer" class="form-control" placeholder="No Rekening/Wallet" value="{{ $item2->no_payment }}" name="no_payment" id="no_payment" required>
                        @error('no_payment')
                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                        @enderror
                    </div>
